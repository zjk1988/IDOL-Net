...
class SE_net(nn.Module):
    def __init__(self):
        ...
        self.up3 = up(filters[2]+filters[2]+1,filters[1],size=[90,91])
        self.up2 = up(filters[1]+filters[1]+1,filters[0],size=[180,183])
        self.up1 = uplast(filters[0]+filters[0]+1,1,size = [361,367])
